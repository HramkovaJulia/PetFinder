...
struct MedecineStatusMainInfoAboutPetAdView: View {
    ...
    var body: some View {
        ...
        case (true, false): Medecine(text: "Вакцинирован")
        case (false , true): Medecine(text: "Стериализован")
        case (true,true):
            HStack (spacing: 14){
                Medecine(text: "Вакцинирован")
                Medecine(text: "Стериализован")
            }
